...
class JvmFlagsTunerInterface(opentuner.measurement.MeasurementInterface):
    ...
    def __init__(self, args, *pargs, **kwargs):
        ...
        self.tuner_iterations=0
        self.apache_flags = None
        self.apache_flag_configuration = {}
        self.mysql_flags = None
	...
	if not os.path.exists(self.tuner_config_file_folder):
        ...
        print 'Initializing the offline tuner...'
        ...
        self.call_program("cp result.dat ./TunedConfiguration/default.dat")
        ...
        self.extract_apache_flags()
        self.extract_mysql_flags()
        self.extract_ajp_flags()
    ...
    def extract_apache_flags(self):
        apache_flags = pd.read_csv(self.configuration_file_folder+'apache2.csv')
        self.apache_bool_flags = apache_flags[apache_flags.type == 'bool']
        self.apache_param_flags = apache_flags[apache_flags.type != 'bool']
        self.apache_flag_names = apache_flags.name.tolist()
        # print self.apache_flag_names

    def extract_mysql_flags(self):
        mysql_flags = pd.read_csv(self.configuration_file_folder+'mysql.csv')
        self.mysql_bool_flags = mysql_flags[mysql_flags.type == 'bool']
        self.mysql_param_flags = mysql_flags[mysql_flags.type != 'bool']
        self.mysql_flag_names = mysql_flags.name.tolist()
        # print self.mysql_flag_names

    def extract_ajp_flags(self):
        ajp_flags = pd.read_csv(self.configuration_file_folder+'ajp.csv')
        self.ajp_bool_flags = ajp_flags[ajp_flags.type == 'bool']
        self.ajp_param_flags = ajp_flags[ajp_flags.type != 'bool']
        self.ajp_flag_names = ajp_flags.name.tolist()
        # print self.ajp_flag_names
